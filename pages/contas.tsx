...
export default function Page() {
  ...
  return (
    <DashboardLayout title="Contas Conectadas" description="Conecte suas contas do Meta Ads">
      <div style={{display:'flex',flexDirection:'column',alignItems:'center',justifyContent:'center',minHeight:'400px',gap:'16px'}}>
        ...
        <h2 style={{fontFamily:"'Orbitron',sans-serif",fontSize:'18px',color:'#F2E4B9',fontWeight:'700'}}>Contas Conectadas</h2>
