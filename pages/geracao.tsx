...
export default function Page() {
  ...
  return (
    <DashboardLayout title="Geração de Campanhas" description="Crie campanhas com IA em 7 etapas">
      <div style={{display:'flex',flexDirection:'column',alignItems:'center',justifyContent:'center',minHeight:'400px',gap:'16px'}}>
        ...
        <h2 style={{fontFamily:"'Orbitron',sans-serif",fontSize:'18px',color:'#F2E4B9',fontWeight:'700'}}>Geração de Campanhas</h2>
